...
<body>
	...
	<div class="container" id="contact">			
		...
		<s:form action="editarServicio.action" method="POST" cssClass="form"  cssStyle="width:500px">
			...
			/>
			<s:submit name="btnEditar" id="btnEditar" cssClass="btn btn-info" value="Editar" />
			<s:actionerror/>
			<s:fielderror/>
		</s:form>
		</div>
